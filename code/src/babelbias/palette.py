...
# ── Canonical language + conflict-family palettes ──────────────────────────
# Language colours: used by every figure that colours by prompt/response
# language. Family colours: used by every figure that colours by conflict
# family; anchored to the conflict-atlas map. The two encodings never
# appear in the same figure; the colour-key figure documents all three.

LANG_COLOR: dict[str, str] = {
    "en": "#2E75B6",   # English — blue
    "ru": "#A50026",   # Russian — deep red
    "uk": "#1A9850",   # Ukrainian — green
    "he": "#6A51A3",   # Hebrew — purple
    "ar": "#E08214",   # Arabic — orange
    "hi": "#C51B8A",   # Hindi — magenta
    "ur": "#35978F",   # Urdu — teal
    "zh": "#8C510A",   # Chinese — brown
    "es": "#545863",   # Spanish — slate
}

LANG_LABEL: dict[str, str] = {
    "en": "English", "ru": "Russian", "uk": "Ukrainian", "he": "Hebrew",
    "ar": "Arabic", "hi": "Hindi", "ur": "Urdu", "zh": "Chinese",
    "es": "Spanish",
}

FAMILY_COLOR: dict[str, str] = {
    "ru_uk":     "#A50026",   # Russia–Ukraine — deep red (matches atlas)
    "il_ps":     "#F59E0B",   # Israel–Palestine — amber (atlas)
    "in_pk":     "#1B9E77",   # India–Pakistan — teal-green (atlas)
    "taiwan":    "#984EA3",   # China–Taiwan — purple (atlas)
    "falklands": "#2563EB",   # UK–Argentina — blue (atlas)
    "cn_jp":     "#8C510A",   # China–Japan — brown
    "gr_tr":     "#7570B3",   # Greece–Turkey — soft violet
    "pl_ru":     "#DD3497",   # Poland–Russia — pink
    "cs_sk":     "#8A8F98",   # Velvet Divorce (settled) — grey
    "no_sv":     "#5A5F6A",   # Norway–Sweden (settled) — dark grey
}

FAMILY_LABEL: dict[str, str] = {
    "ru_uk": "Russia–Ukraine", "il_ps": "Israel–Palestine",
    "in_pk": "India–Pakistan", "taiwan": "Taiwan strait",
    "falklands": "Falklands", "cn_jp": "China–Japan",
    "gr_tr": "Greece–Turkey", "pl_ru": "Poland–Russia",
    "cs_sk": "Velvet Divorce (settled)", "no_sv": "Norway–Sweden (settled)",
}
